...
public:
    ...
    void booksList() {
        ...
        std::cout << std::setw(10) << "Book id" << std::setw(30) << "Book Name" << std::setw(20) << "Author" << std::setw(20) << "Date\n\n";

        while (temp != nullptr) {
            std::cout << std::setw(10) << temp->id << std::setw(30) << temp->bookName << std::setw(20) << temp->authorName << std::setw(20) << temp->date << "\n";
            temp = temp->next;
        }
